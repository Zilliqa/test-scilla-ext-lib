...
async function main() {
    ...
    if (myArgs.length < 3) {
        ...
        console.log("node deploy-contract.js [private_key] [testnet / mainnet] [ext_lib_addr]");
        return;
    }
    ...
    console.log("ext lib contract: ", extLibContract);
    ...
    try {
        ...
        // deploy impl
        const implCode = fs.readFileSync(__dirname + '/../contracts/contract2.scilla', 'utf-8');
        const init = [
            {
                ...
                value: [
                    {
                        ...
                        "arguments": ["AdditionLib", `${extLibContract}`],
                    }
                ],
            },
        ];
